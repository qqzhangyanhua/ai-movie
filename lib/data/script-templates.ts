...
export const scriptTemplates: ScriptTemplate[] = [
  ...
  },
  {
    ...
    title: "校园告别",
    category: "校园",
    description: "毕业前夕，同学们整理书桌、拍合照、挥手道别。",
    scenes: [
      {
        sceneNumber: 1,
        description: "教室里，同学们整理书桌和课本。",
        action: "学生们把书本装进书包，环顾熟悉的教室。",
        cameraType: "中景",
        duration: 5,
      },
      {
  ...
  },
  {
    ...
    scenes: [
      ...
      },
      {
        ...
        action: "主角展开信纸，神情逐渐凝重。",
        cameraType: "中景",
        duration: 5,
      },
      {
        sceneNumber: 3,
        description: "主角收拾行装，准备前往信中地点。",
        action: "主角拿起外套，推门走入夜色。",
        cameraType: "远景",
        duration: 5,
      },
    ],
